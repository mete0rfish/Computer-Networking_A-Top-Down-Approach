...
---
**[ 추가 ]**
- 대부분의 데이터는 `bursty`하기 때문에, 리소스 쉐어링 같은 대부분의 경우에 패킷 교환이 유리하다.
- 하지만, 지나친 밀집으로 패킷 딜레이가 발생할 수 있다.
- 따라서, 서킷 교환은 꾸준하게 데이터가 올 경우에 유리한 방식이다.
...
그러나 종단 사용자들과 콘텐츠 제공자들을 모두 접속 ISP로 연결하는 것은 말도 안 된다. (매우 복잡하기 때문)

<img width="720" alt="image" src="https://github.com/user-attachments/assets/ecce88ca-cdca-4a4f-ad49-0135d95272b5">
